...
export default function Google() {
  ...
  return (
    <section className="mx-3">
      ...
      >
        <img
          src="https://i.ibb.co/yPFB8wf/Google-Pixel-7-Watch36.jpg"
          alt="image 1"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/cXsVpmv/Ea2oc-Tb-Jmzn-SXpcyd-WJp2i.jpg"
          alt="image 2"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/pJDp4FC/1668481228-2.jpg"
          alt="image 3"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
      </Carousel>
