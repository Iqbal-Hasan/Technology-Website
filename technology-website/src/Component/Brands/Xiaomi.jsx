...
export default function Xiaomi() {
  ...
  return (
    <section className="mx-3">
      ...
      >
        <img
          src="https://i.ibb.co/NZ7b47t/Xiaomi-Pad-5-DSC00505.jpg"
          alt="image 1"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/SQTYgTB/7873b767-15a3-4eb0-890f-a79e7e2dd382-dde59eb0.jpg"
          alt="image 2"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/xFhSx5s/geek-review-xiaomi-13-ultra-10-1.jpg"
          alt="image 3"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
      </Carousel>
