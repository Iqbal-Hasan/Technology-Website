...
export default function Microsoft() {
  ...
  return (
    <section className="mx-3">
      ...
      >
        <img
          src="https://i.ibb.co/p2kSmGr/surfaceblack.jpg"
          alt="image 1"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/G2pQDYp/microsoft-surface-pro-6-review-23.jpg"
          alt="image 2"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/fnvmT4T/RE5c921-Surface-Pro-9-Product-Sizzle-en-us-scl-1.webp"
          alt="image 3"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
      </Carousel>
