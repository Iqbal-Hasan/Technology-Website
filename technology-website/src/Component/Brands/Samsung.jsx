...
export default function Samsung() {
  ...
  return (
    <section className="mx-3">
      ...
      >
        <img
          src="https://i.ibb.co/nLhsjX5/photo-1610792516775-01de03eae630-ixlib-rb-4-0.jpg"
          alt="image 1"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/vcqgTjk/1587462262067-large-large.jpg"
          alt="image 2"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/x1VKKJx/hands-on-samsungs-galaxy-s23-line-puts-up-to-200-megapixels-wcc2.jpg"
          alt="image 3"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
      </Carousel>
