...
export default function Apple() {
  ...
  return (
    <section className="mx-3">
      ...
      <Carousel
        className="rounded-lg xl:max-w-screen-xl xl:mx-auto overflow-hidden"
      ...
      >
        <img
          src="https://i.ibb.co/Gxqf0MH/nikita-kachanovsky-OVbe-SXRk-9-E-unsplash.jpg"
          alt="image 1"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/PwJrQ3y/julian-o-hayon-HY3l4-Ie-Oc3-E-unsplash.jpg"
          alt="image 2"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
        <img
          src="https://i.ibb.co/fdHWRHC/lucas-hoang-nf-OJXUFfcz-Q-unsplash.jpg"
          alt="image 3"
          className="md:h-[600px] sm:h-[500px] h-[400px] lg:h-[700px] w-full object-cover object-center"
        />
      </Carousel>
