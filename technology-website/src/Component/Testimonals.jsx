  ...
  const testimonials = [
    {
      ...
      quote:
        "Tech world streamlined processes and efficient workflows are a testament to their commitment to delivering results in a timely manner. They understand the importance of speed in the tech world.",
    },
    {
      ...
      quote:
        "The level of customer support at Tech World is exceptional. Their team is responsive, knowledgeable, and always willing to go the extra mile to ensure all queries and concerns are addressed promptly.",
    },
    {
      ...
      quote:
        "Tech World consistently delivers cutting-edge solutions. Their innovative approach to problem-solving and product development showcases their dedication to pushing boundaries in the tech industry.",
    },
  ];

  return (
    <section className="relative py-24 bg-[#FAEAFE] dark:bg-[#1d2027]">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          <h3 className="text-gray-800 sm:text-4xl mx-auto block text-4xl font-medium border-b-4 w-fit border-black border-dotted dark:text-white dark:border-white mb-10">
            Hear from our customers
          </h3>
          <p className="mt-3 text-gray-600 dark:text-gray-300">
            Here from our customers and sellers. They are really happy to work with us. 
            They are a part of our website. From their review and advise we imporve ourself
            futher more. Let&apos;s see their sweet review.
          </p>
        </div>
        <div className="mt-12">
